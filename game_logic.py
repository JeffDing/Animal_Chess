...
class DoushouqiGame:
    ...
    def init_board(self):
        ...
        pieces = [
            # 红方棋子
            ('象', 8, 'red', (0, 0)), ('狮', 7, 'red', (0, 6)),
            ('虎', 6, 'red', (1, 1)), ('豹', 5, 'red', (1, 5)),
            ('狼', 4, 'red', (2, 0)), ('狗', 3, 'red', (2, 6)),
            ('猫', 2, 'red', (1, 0)), ('鼠', 1, 'red', (2, 2)),
            
            # 蓝方棋子
            ('象', 8, 'blue', (8, 6)), ('狮', 7, 'blue', (8, 0)),
            ('虎', 6, 'blue', (7, 5)), ('豹', 5, 'blue', (7, 1)),
            ('狼', 4, 'blue', (6, 6)), ('狗', 3, 'blue', (6, 0)),
            ('猫', 2, 'blue', (7, 6)), ('鼠', 1, 'blue', (6, 4))
        ]
